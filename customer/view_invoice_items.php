<?php
	...
	if(isset($_SESSION['customer_login'])) {
		if(isset($_GET['id'])){
			...
			$querySelectInvoice = "SELECT * FROM invoice,retailer,distributor,area WHERE invoice_id='$invoice_id' AND invoice.cus_id=cus.cus_id AND customer.location=location.location AND invoice.cus_id=customer details.cus_id";
