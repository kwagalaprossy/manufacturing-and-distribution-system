	...
	if($_SERVER['REQUEST_METHOD'] == "POST") {
		if(!empty($_POST['txtUsername']) && !empty($_POST['txtPassword']) && isset($_POST['login_type'])){
			...
			if($_SESSION['sessLogin_type'] == "retailer") {
				...
				//if selected type is manufacturer than check for valid manufacturer.
				$query_selectCustomer = "SELECT cus_id,username,password FROM customer WHERE username='$username' AND password='$password'";
...
<body class="login-box">
	...
	<li>
		...
		<option value="manufacturer">Distributor</option>
		<option value="manufacturer">Wholesaler</option>
