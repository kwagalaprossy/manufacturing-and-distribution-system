			...
			<div data-simplebar class="sidebar-menu-scroll" style="background-color:rgb(244, 254, 67);">
				...
				<div id="sidebar-menu" >
					...
					<ul class="metismenu list-unstyled" id="side-menu">
						...
						<li>
							<a href="index.html" class="waves-effect"> <i class="uil-calender "></i> <i class="bi bi-grid fa-3x"></i></i><span>Dashboard</span> </a>
						</li>
						
						
							<li>
							<a href="edit_profile.php" > <i class="uil-store"> </i><i class="fas fa-users fa-3x"></i> <span>Edit profile</span> </a>
						...
						<li>
							...
							<li>
							<a href="pro.html" > <i class="uil-store"></i> <i class="fas fa-shopping-cart fa-3x"></i> <span>Add Product</span> </a>
							
						</li>
						
						</li>
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect"> <i class="uil-store"></i> <i class="fas fa-shopping-cart fa-3x"></i></i> <span>Order</span> </a>
							<ul class="sub-menu" aria-expanded="false">
								<li><a href="view_my_orders.php">My Orders</a></li>
								<li><a href="order_items.php">New Orders</a></li>
								
							</ul>
						</li>

						<li>
							<a href="orders.php" > <i class="uil-store"></i> <i class="fas fa-shopping-cart fa-3x"></i> <span>Orders</span> </a>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-6 col-xl-3">
							<div class="card" style="background-color:rgb(254, 93, 93);">
								<div class="card-body">
						...
						<!-- end col-->
						<div class="col-md-6 col-xl-3">
							<div class="card" style="background-color:rgb(200, 105, 76);">
								<div class="card-body">
									<div class="float-end mt-2">
										<i class="fas fa-users fa-3x"></i>
									</div>
						...
						<!-- end col-->
						<div class="col-md-6 col-xl-3">
							<div class="card" style="background-color:rgb(52, 32, 107);">
								<div class="card-body">
									<div class="float-end mt-2">
										<i class="fas fa-users fa-3x"></i>
									</div>
						...
						<!-- end col-->
						<div class="col-md-6 col-xl-3">
							<div class="card" style="background-color:rgb(110, 233, 96);">
								<div class="card-body">
									<div class="float-end mt-2">
										<i class="fas fa-users fa-3x"></i>
									</div>
					...
					<div class="row">
						<div class="col-md-6 col-xl-3">
							<div class="card" style="background-color:rgb(248, 67, 167);">
								<div class="card-body">
									<div class="float-end mt-2">
						...
						<!-- end col-->
						<div class="col-md-6 col-xl-3">
							<div class="card" style="background-color:rgb(48, 251, 251);">
								<div class="card-body">
									<div class="float-end mt-2">
						...
						<!-- end col-->
						<div class="col-md-6 col-xl-3">
							<div class="card" style="background-color:rgb(36, 245, 102);">
								<div class="card-body">
									<div class="float-end mt-2">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-sm-6">
							...
							</script> © manufacturing and distribution. </div>
